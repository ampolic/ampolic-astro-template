...
export const site: Site = {
  ...
  city: "Boulder",
  /* Public demo deployment; generated client sites replace this with their domain. */
  url: "https://ampolic-astro-template.pages.dev",
  logo: "/favicon.svg",
  ...
  credentials: {
    ...
    licenses: [
      "Colorado Master HVAC Contractor #EA-4471",
      "Licensed & insured in Boulder County",
    ],
    certifications: [
