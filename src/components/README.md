...
Shared primitives (Button, Card, Callout, CtaBand, EmailLink, FaqList, FormInput,
FormSelect, FormTextarea, Prose, SectionHeading, TestimonialCard) come from
**`@ampolic/ui`** (GitHub Packages —
...
ContactSplit (the editable full-bleed contact layout), Hero, blog components,
ServiceAreaMap, ThemeToggle.
